import { Menu, Bell, User, Settings, Accessibility, LogOut, User2Icon, Search} from "lucide-react"
        ...
        <header>
            ...
            >
                <ul style={{}} className="user-menu">
                    ...
                    <li>
                        <button className="btn-user-modal" onClick={()=>redirect('/acessibility')}><Accessibility color='black'></Accessibility>Acessibilidde</button>
                    </li>
                    <li>
